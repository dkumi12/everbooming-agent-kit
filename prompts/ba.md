...
- Quantify the problem if possible (market size, affected users, cost of the problem)
...
## 4. Business Value
- Revenue potential (subscription, transactional, freemium, etc.)
...
Create 2-3 detailed personas using this exact format for each:
...
**Quote:** *"[A quote that captures their core need]"*
...
Output in clean, structured Markdown with all sections fully completed.
